//package com.sgenc.officeslip.View.FileExplorer;
//
...
//import android.ja.view.LayoutInflater;
//import android.ja.view.MotionEvent;
//import android.ja.view.View;
//import android.ja.view.ViewGroup;
...
//
//public class DirectoryFragment_bak extends Fragment {
//
...
//        public void didSelectFiles(DirectoryFragment_bak activity, ArrayList<String> files);
//
...
//                @Override
//                public void onItemClick(AdapterView<?> adapterView, View ja.view,
//                                        int i, long l) {
//                    if (i < 0 || i >= items.size()) {
//                        return;
//                    }
...
//                                delegate.didSelectFiles(DirectoryFragment_bak.this, files);
//                            }
//                        } else {
...
//    }
//
//    public static void clearDrawableAnimation(View ja.view) {
//        if (Build.VERSION.SDK_INT < 21 || ja.view == null) {
//            return;
//        }
//        Drawable drawable = null;
//        if (ja.view instanceof ListView) {
//            drawable = ((ListView) ja.view).getSelector();
//            if (drawable != null) {
//                drawable.setState(StateSet.NOTHING);
//            }
//        } else {
//            drawable = ja.view.getBackground();
//            if (drawable != null) {
//                drawable.setState(StateSet.NOTHING);
