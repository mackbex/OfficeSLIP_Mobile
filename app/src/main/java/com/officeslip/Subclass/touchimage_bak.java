...
// */
//
//package com.woonam.officeslip.Subclass;
//
//
...
//import android.ja.view.GestureDetector;
//import android.ja.view.MotionEvent;
//import android.ja.view.ScaleGestureDetector;
//import android.ja.view.View;
//import android.ja.view.WindowManager;
//import android.ja.view.animation.AccelerateDecelerateInterpolator;
...
// */
//
//public class touchimage_bak extends android.support.v7.widget.AppCompatImageView {
//
...
//    // when the image is stretched to fit ja.view.
//    //
...
//
//    //
//    // Size of image when it is stretched to fit ja.view. Before and After rotation.
//    //
...
//    }
//
//    public touchimage_bak(Context context) {
//        super(context);
//        sharedConstructing(context);
//        //init(null, 0);
//    }
//
//    public touchimage_bak(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        sharedConstructing(context);
//        //init(attrs, 0);
//    }
//
//    public touchimage_bak(Context context, AttributeSet attrs, int defStyle) {
...
////                String image			= memoEntry.getNoteImage();
...
//        // image and ja.view sizes have not yet been calculated in onMeasure. Thus, we should
...
//     * and top of the ja.view. For example, the top left corner of the image would be (0, 0).
...
//     * the image can become unaligned within the ja.view. This is apparent when zooming
...
//     * then makes sure the image is centered correctly within the ja.view.
//     */
...
//            //
//            // Stretch and center image to fit ja.view
//            //
...
//     * @param prevImageSize the width/weight of the image before the rotation
//     * @param imageSize width/weight of the image after rotation
...
//            //
//            // The width/weight of image is less than the ja.view's width/weight. Center it.
//            //
//            m[axis] = (viewSize - (drawableSize * m[Matrix.MSCALE_X])) * 0.5f;
//
//        } else if (trans > 0) {
//            //
//            // The image is larger than the ja.view, but was not before rotation. Center it.
//            //
//            m[axis] = -((imageSize - viewSize) * 0.5f);
//
//        } else {
//            //
//            // Find the area of the image which was previously centered in the ja.view. Determine its distance
//            // from the left/top side of the ja.view as a fraction of the entire image's width/weight. Use that percentage
...
//     * @param clipToBitmap Touch event may occur within ja.view, but outside image content. True, to clip return value
